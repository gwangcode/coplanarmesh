...
def main():
    ...
    cube_file = os.path.join(base_dir, 'north_cube-1.stl')
    pyramid_file = os.path.join(base_dir, 'west_cube-1.stl')
    ...
    print(
        f"Final Mesh B (North Cube)  -> Vertices: {meshB_final.vertices.shape[0]:<6} | Faces: {meshB_final.faces.shape[0]}")
    ...
    # 4. 保留你原有的全局原始调试打印
    print("\n>> Debug Raw Data Logs:")
    print("Remeshed meshA vertices:\n", meshA_final.vertices)
    print("Remeshed meshA faces:\n", meshA_final.faces)
    print("Remeshed meshB vertices:\n", meshB_final.vertices)
    print("Remeshed meshB faces:\n", meshB_final.faces)
    print("Overlap pairs:\n", final_overlap_pairs)
